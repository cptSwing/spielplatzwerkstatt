<header class="sticky top-0 z-50 w-full h-(--header-footer-height) mb-(--header-footer-margin) drop-shadow-md">
    <div class="pt-[calc(var(--header-footer-offset)/4)] [clip-path:polygon(0%_0%,100%_0%,100%_calc(100%-var(--header-footer-offset)),0%_100%)] flex flex-row gap-6 justify-end md:justify-center items-center size-full bg-white" >
