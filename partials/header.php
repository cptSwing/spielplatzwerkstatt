<header class="sticky top-0 z-50 w-full h-(--header-footer-height) mb-(--header-footer-margin) drop-shadow-md">
    <div
        ...
        <div class=" flex flex-row gap-6 justify-end md:justify-start items-center">
            <input id="input-radio-hamburger" name="input-hamburger" type="checkbox"
                class="peer [clip-path:polygon(0%_0%,0%_0%,0%_0%)] absolute -z-50" />
            <label for="input-radio-hamburger" class="flex flex-col md:hidden justify-around gap-1 size-9">
                <div class="w-full h-2 bg-neutral-400"></div>
                <div class="w-full h-2 bg-neutral-400"></div>
                <div class="w-full h-2 bg-neutral-400"></div>
            </label>

            <div class="hidden flex-col peer-checked:flex md:contents peer-checked:fixed left-2 top-0">
                <div class="header-menu-item group">
                    <input id="input-radio-spielplatzbau" name="input-radio-leistungen" type="radio" <?php if ($slug == 'spielplatzbau') {
                ...
                <div class="header-menu-item group">
                    <input id="input-radio-galabau" name="input-radio-leistungen" type="radio" <?php if ($slug == 'galabau') {
                        echo 'checked="checked"';
                    } ?>
                    class="peer [clip-path:polygon(0%_0%,0%_0%,0%_0%)] absolute -z-50" />
                ...
                <div class="header-menu-item group">
                    <input id="input-radio-naschgarten" name="input-radio-leistungen" type="radio" <?php if ($slug == 'naschgarten') {
                        echo 'checked="checked"';
                    } ?>
                    class="peer [clip-path:polygon(0%_0%,0%_0%,0%_0%)] absolute -z-50" />
                ...
                <div class="header-menu-item group">
                    <input id="input-radio-workshops" name="input-radio-leistungen" type="radio" <?php if ($slug == 'workshops') {
                        echo 'checked="checked"';
                    } ?>
                    class="peer [clip-path:polygon(0%_0%,0%_0%,0%_0%)] absolute -z-50" />
