<header class="sticky top-0 z-50 w-full h-(--header-footer-height) px-(--container-horizontal-margin)  mb-(--header-footer-margin) [clip-path:polygon(0%_0%,100%_0%,100%_calc(100%-var(--header-footer-offset)),0%_100%)] bg-theme-fill-1 flex flex-row gap-0.5 justify-end md:justify-center items-center ">
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-spielplatzbau" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/spielplatzbau.php">Spielplatzbau</a>
            </label>
        </div>
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-galabau" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/galabau.php">Garten- & Landschaftsbau</a>
            </label>
        </div>
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-naschgarten" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/naschgarten.php">Naschgarten</a>
            </label>
        </div>
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-workshops" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/workshops.php">Workshops</a>
            </label>
        </div>
</header>
