<header class="sticky top-0 z-50 w-full h-(--header-footer-height) px-(--container-horizontal-margin)  mb-(--header-footer-margin) [clip-path:polygon(0%_0%,100%_0%,100%_calc(100%-var(--header-footer-offset)),0%_100%)] bg-theme-secondary flex flex-row gap-0.5 justify-end md:justify-center items-center ">

        <a class="absolute py-3 h-full left-(--container-horizontal-margin)" href="../index.php">
            <img class="size-full object-contain image-hover" src="../images/logo_spielplatzwerkstatt_209x204.png"/>
        </a>
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-spielplatzbau" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/spielplatzbau.php">
                    <h6>Spielplatzbau</h6>
                </a>
            </label>
        </div>
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-galabau" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/galabau.php">
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-naschgarten" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/naschgarten.php">
                    <h6>Naschgarten</h6>
                </a>
            </label>
        </div>
        ...
        <div class="inline-block mt-[calc(var(--header-footer-offset)/2)]">
            ...
            <label for="input-radio-workshops" class="radio-leistungen-label">
                <a class="text-inherit! select-none inline-block py-px px-0.5 text-xs md:text-sm md:py-1 md:px-2" href="../pages/workshops.php">
                    <h6>Workshops</h6>
                </a>
            </label>
        </div>
