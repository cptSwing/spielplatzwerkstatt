...
const Leistungen = ({ leistungsData, route }: { leistungsData: ACF_Leistung_Type; route: ArrayElement<typeof ROUTES> }) => {
    const {
        ...
        infokarte_5,
        produkt_story_a,
        zweite_produkt_story,
        produkt_story_b,
        dritte_produkt_story,
        produkt_story_c,
    } = leistungsData;
    ...
    return (
        ...
        >
            ...
            {zweite_produkt_story && produkt_story_b && <ProduktStory storyData={produkt_story_b} />}
            {dritte_produkt_story && produkt_story_c && <ProduktStory storyData={produkt_story_c} />}
        </main>
    );
};
